...
COLUMN total_spend   FORMAT 999,999,990.00
COLUMN order_revenue FORMAT 999,999,990.00
COLUMN running_total_revenue FORMAT 999,999,990.00
COLUMN price         FORMAT 999,990.00
...
SELECT o.customer_id, c.customer_name, o.order_id, o.order_date,
       ROW_NUMBER() OVER (PARTITION BY o.customer_id
                          ORDER BY o.order_date, o.order_id) AS order_seq
FROM orders o
...
SELECT customer_id, customer_name, order_id, order_date, previous_order_date,
       ROUND(order_date - previous_order_date) AS days_since_previous_order
FROM order_gaps
